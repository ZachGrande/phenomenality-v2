...
function Superhuman() {
  return (
    <div className={styles['imposter-content']}>
      ...
      <h2>overview</h2>
      <p>
        The superhuman represents a person with imposter phenomenon that
        struggles with work addiction. This person may feel inadequate relative
        to colleagues and continue to push themselves regardless of the
      ...
      <div className={styles['float-video']}>
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/MFd7I4iWeTg?start=94"
      ...
      <ul>
        <li>
          Imposter workaholics are actually addicted to the validation that
          comes from working, not to the work itself. Start training yourself to
          veer away from external validation. No one should have more power to
          make you feel good about yourself than you–-even your boss when they
          give your project the stamp of approval.
        </li>
        <li>
          On the flip side, learn to take constructive criticism at face value,
          not personally.
        </li>
        <li>
      ...
      <ul>
        <li>
          <a href="https://fairygodboss.com/articles/5-ways-to-combat-your-need-for-constant-validation-at-work">
            5 Ways to Combat Your Need For Constant Validation at Work
          </a>
        </li>
        <li>
          <a href="https://www.livewellwithsharonmartin.com/validate-yourself/">
