  ...
  return (
    <div className={styles['imposter-content']}>
      ...
      <p>
        ...
        good enough despite valid qualifications. This person may feel like they
        are less experienced than their colleagues if they do not know an answer
      ...
      <div className={styles['float-video']}>
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/MFd7I4iWeTg?start=111"
      ...
      <ul>
        <li>
          <a href="https://www.fastcompany.com/3062984/a-guide-to-uncertainty-for-people-who-hate-not-knowing">
            A Guide To Uncertainty For People Who Hate Not Knowing
          </a>
        </li>
        <li>
          <a href="https://www.lifehack.org/620152/the-art-of-not-knowing">
